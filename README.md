...
- [SpawnDev.ILGPU](https://github.com/LostBeard/SpawnDev.ILGPU) - Run ILGPU kernels in Blazor WebAssembly via WebGPU, Web Workers, or CPU — with automatic backend selection..  
