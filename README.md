...
- [SpawnDev.BlazorJS](https://github.com/LostBeard/SpawnDev.BlazorJS) provides the missing link to Blazor WASM, giving C# access to all Javascript web browser APIs and data types.  
